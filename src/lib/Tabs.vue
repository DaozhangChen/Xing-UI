<template>
  <div class="xing-tabs">
    <div class="xing-tabs-nav" ref="container">
      <div class="xing-tabs-nav-item" v-for="(t, index) in titles"
        :ref="el => { if (t === selected) selectedItem = el }" @click="select(t)" :class="{ selected: t === selected }"
        :key="index">{{ t }}</div>
      <div class="xing-tabs-nav-indicator" ref="indicator"></div>
    </div>
    <div class="xing-tabs-content">
